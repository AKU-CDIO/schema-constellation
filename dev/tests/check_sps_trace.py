...
with sync_playwright() as p:
    ...
    pg.evaluate("document.querySelector('#topic-diagnosis .trace-pid').value = 'P12345'")
    pg.evaluate("document.querySelector('#topic-diagnosis .trace-btn').click()")
    pg.wait_for_timeout(300)
    sql = pg.evaluate("document.querySelector('#topic-diagnosis .trace-code').textContent")
    ...
    chipOk = pg.evaluate("getComputedStyle(document.querySelector('#topic-diagnosis .sp-meta .chip')).borderRadius")
